...
public class ConfigManager {
    ...
    public void save() {
        ...
        builder.setValue("Prefix.Freund", ChatColor.translateAlternateColorCodes('&', "§6Freund §7| §6"));
        ...
        builder.setValue("Prefix.Premium", ChatColor.translateAlternateColorCodes('&', "§6"));
